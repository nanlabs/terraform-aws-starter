...
- CI toolchain currency: `setup-node` v4 → v7, `pnpm/action-setup` v4 → v6, `terraform-docs/gh-actions` 1.2.0 → 1.4.1, `todo-to-issue-action` v4 → v5, `danger` 13 → 14, `typescript` 5.9 → 7.0 (tsc clean)
...
[Unreleased]: https://github.com/nanlabs/terraform-aws-modules/compare/v0.11.0...HEAD
